...
DEFAULT_CLIENT_HEADER_TIMEOUT_SECONDS = 5.0
DEFAULT_MAX_CLIENT_HANDLER_THREADS = 256
DEFAULT_MAX_PENDING_UPSTREAM_SETUPS = 32
DEFAULT_MAX_ACTIVE_TUNNELS_PER_CLIENT_DESTINATION = 0
...
CONNECT_TIMEOUT_SECONDS_LIMIT = 120
ROUTE_DECISION_CACHE_MAX_SIZE = 4096
RETRYABLE_HTTP_METHODS = {"GET", "HEAD", "OPTIONS", "TRACE"}
BUFFER_SIZE = 64 * 1024
MAX_TUNNEL_PENDING_BYTES = 2 * 1024 * 1024
TUNNEL_HALF_CLOSE_DRAIN_SECONDS = 5.0
HOP_BY_HOP_HEADERS = {
    "connection",
    "keep-alive",
    "proxy-authenticate",
...
DASHBOARD_LIVE_DEBOUNCE_SECONDS = 0.5
DASHBOARD_LIVE_EVENT_BACKLOG = 256
PROXY_QUOTA_SNAPSHOT_CACHE_SECONDS = 5.0
PROXY_QUOTA_SNAPSHOT_CACHE_MAX_SIZE = 64
LOG_WRITER_QUEUE_MAX_SIZE = 10000
LOG_WRITER_FLUSH_INTERVAL_SECONDS = 0.5
UPSTREAM_STATUS_PROBE_TIMEOUT_SECONDS = 3
HISTORY_DEFAULT_RANGE = "24h"
HISTORY_SUMMARY_CACHE_SECONDS = 60
HISTORY_SUMMARY_CACHE_MAX_SIZE = 64
